/**
 * English demo register.
 *
 * Fixtures are per language so a demo reads naturally in the language it is
 * shown in. The stored vocabulary values (status, category, severity) stay in
 * English in both sets - those are canonical data, translated only for display.
 */
